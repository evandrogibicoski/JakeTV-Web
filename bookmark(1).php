  ...
  <div class="welcome"> 
    ...
    <div class="row" id="content_likes">
        ...
        <div class="form-group  label-floating" id="home_search_css">
          ...
          <input type="text" class="form-control input-lg" id="serachdata" onKeyUp="bookmark_searcheddata()" style="border:none;border-bottom:1px solid #00AA9A;" />
        </div>
      </div>
           <!-- <div class="col-lg-2">
    ...
    <?php
                                ...
                                <div class="post_button col-md-12 col-lg-12 col-sm-12 col-xs-12"> 
                                    ...
                                    if(isset($_SESSION['sessionid'])){
                                        ...
                                        if($fetch_post[$i]['isbookmarked'] == 1){ ?>
                                            <a onClick="unbookmark_post_bookmark(<?php echo $fetch_post[$i]['postid']; ?>)" id="bookmark_post" class="bookmark_post<?php echo $fetch_post[$i]['postid']; ?>">UNBOOKMARK</a>
					...
					<?php }else{ ?>
                                ...
                                <div class="post_button col-md-12 col-lg-12 col-sm-12 col-xs-12"> 
                                    ...
                                    if(isset($_SESSION['sessionid'])){
                                        ...
                                        if($fetch_post[$i]['isliked'] == 1){ ?>
                                            <a onClick="unlike_post(<?php echo $fetch_post[$i]['postid']; ?>)" id="like_post" class="like_post<?php echo $fetch_post[$i]['postid']; ?>">ULIKE</a>
                                            <a onClick="like_post(<?php echo $fetch_post[$i]['postid']; ?>)" id="like_post1" class="like_post1<?php echo $fetch_post[$i]['postid']; ?>" style="display:none;">LIKE</a>&nbsp;&nbsp;
                                        <?php }else{ ?>
                                            <a onClick="like_post(<?php echo $fetch_post[$i]['postid']; ?>)" id="like_post1" class="like_post1<?php echo $fetch_post[$i]['postid']; ?>">LIKE</a>
                                            <a onClick="unlike_post(<?php echo $fetch_post[$i]['postid']; ?>)" id="like_post" style="display:none;" class="like_post<?php echo $fetch_post[$i]['postid']; ?>">ULIKE</a>&nbsp;&nbsp;
                                        <?php } ?>
		...
		if(isset($_SESSION['bookmark_pagedata'])){
			if($_SESSION['bookmark_pagedata'] < $total_bookmark_rows){ ?>
			  ...
			  <div class="col-sm-2" onClick="load_bookmark_page1(<?php if(isset($_SESSION['bookmark_page'])){echo ($_SESSION['bookmark_page']);} ?>)">
