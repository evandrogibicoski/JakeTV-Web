...
<title>JAKETV | USER</title>
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">
<link rel="shortcut icon" href="images/favjaketv.png" />
<link href="../jaketv_admin/css/font-awesome.css" rel="stylesheet" type="text/css" />
<link href="../jaketv_admin/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="../jaketv_admin/css/animate.css" rel="stylesheet" type="text/css" />
<link href="../jaketv_admin/css/admin.css" rel="stylesheet" type="text/css" />
<style type="text/css">
.block_innerdiv{background-image:url(../jaketv_admin/images/loader.GIF);height:103px;width:100px;display:inline-block;z-index:1102;}
...
function resetpassword()
{
	...
	else
	{
		...
		$.ajax( {
			url : 'ajaxdata.php', 
			type : 'post',
			data: 'resetpass_user=1&new_pass='+new_pass+'&userid='+userid+'&email='+email,				
...
<body class="light_theme  fixed_header left_nav_fixed" style="background-color:#4b2121;">
    ...
    <!---AJAX LOADER--->
<div style="min-height: 657px; width: 100%; background: transparent url(../jaketv_admin/images/admin_homepage_bg.png) no-repeat scroll center top / 100% auto;">
<div class="wrapper">
	<div class="panel-heading border" style="padding-left:8.1em;padding-top: 20px;">
        <div style="color:#a7dad3;font-size:40px;width:160px;float:left;"><img src="../jaketv_admin/images/jakelogo.png" /></div>
    </div>
    ...
    <form action="" method="post" id="form-info" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="form-group">
        <div class=" col-sm-10">
            <input type="hidden" id="userid" name="userid" value="<?php if(isset($_GET["secure"])) echo $_GET["secure"]?>"/>
