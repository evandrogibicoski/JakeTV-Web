...
if (!empty($qry02)) {
    foreach ($qry02 as $qry) {
        $id = $qry['catidu'];
        $qry021 = $obj->qry_fetchRows("SELECT * FROM `tbl_post` WHERE find_in_set($id,catid) AND status='1' order by sort_order asc");
        $dd[] = $qry021;
    }
...
if (isset($_SESSION['sessionid'])) {
    ...
    if (!empty($all_post_id1)) {
        ...
        $fetch_post = $obj->qry_fetchRows("SELECT * FROM tbl_post WHERE postid IN (" . $d . ") order by sort_order asc LIMIT $PageLimit");
        $total_post_rows = $obj->qry_numrows("SELECT * FROM tbl_post WHERE postid IN (" . $d . ") order by sort_order asc");
    } else {
        @$fetch_post == array();
        $total_post_rows = 0;
    }
                        ...
                        for ($i = 0; $i < $count; $i++) {
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 col-lg-height" id="content_height">
                                <div class="inside inside-full-height">
                                    <div class="content">
                                        <div id="fix_column"> <img src="<?php echo $fetch_post[$i]['image']; ?>" id="CatPage_img" width="350" height="200" onClick="window.open('<?php echo $fetch_post[$i]['url']; ?>', '_blank')" />
                        ...
                        if ($_SESSION['pagedata'] < $total_post_rows) {
                            ...
                            <div class="row" id="load_more">
                                ...
                                ?>,<?php echo $total_post_rows; ?>)">
                                    ...
                                    ?>"/>
                                    <button type="button" class="form-control input-lg btn btn-primary btn-raised">LOAD MORE</button>
                                </div>
                                <div class="col-sm-5"></div>
                            </div>
                            <?php
                                        ...
                                        <form name="login_form" method="post" style="margin-top:-55px;">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-6 col-md-6 col-xs-11">
                                                    ...
                                                    <button type="button" onClick="login_user()" name="login" id="login_button" class="form-control input-lg btn btn-primary btn-raised" style="margin-left:8px;font-size:14px;border-radius:3px; color:#fff;"> Sign in with Jake TV</button>
                                                </div>
                                                <div class="col-sm-12 col-lg-6 col-md-6 col-xs-11" >
                                                    <button type="button" id="login_google_button" class="form-control input-lg btn btn-danger btn-raised" style="margin-left:-18px;border-radius:3px; color:#fff; font-size:14px;"> Sign In with g+</button>
                                                </div>
                                        ...
                                        <form name="register_form" method="post" style="margin-top:-75px;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                    <button type="button"  class="form-control input-lg btn btn-danger btn-raised" onClick="login.php" data-dismiss="modal" id="reg_cancel" style="margin-left:10px;border-radius:3px; font-size:14px;color:#fff;"> Cancel</button>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6" id="reg_join" onClick="register_join()">
                                                    <button type="button"  id="joinbtn" class="form-control input-lg btn btn-primary btn-raised" style="margin-left:-15px;border-radius:3px; font-size:14px;color:#fff;"> Join</button>
                                                </div>
                                ...
                                <div class="tab-pane" id="3">
                                    <div class="row" id="forgotpassword">
                                        <form name="formfrpass" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
                                                    <button type="button"  class="form-control input-lg btn btn-danger btn-raised" onClick="login.php" id="fr_cancel" style="margin-left:10px;border-radius:3px;font-size:14px; color:#fff;" data-dismiss="modal"> Cancel</button>
                                                </div>
                                                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6" id="reg_join" onClick="register_join()">
                                                    <button type="button"  id="frbtn" class="form-control input-lg btn btn-primary btn-raised btnmargn"  onclick="forgot_password()" style="margin-left:-12px;border-radius:3px;font-size:14px; color:#fff;"> Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
<!--                        <a href="https://www.addthis.com/bookmark.php?source=tbx32nj-1.0&v=300&url=http%3A%2F%2F52.0.55.172%2Fjaketv%2Fjaketv_website%2Findex.php&pubid=ra-567638a77cf41b9c&ct=1&title=Share%20Post&pco=tbxnj-1.0" target="_blank"><img src="https://cache.addthiscdn.com/icons/v2/thumbs/32x32/addthis.png" border="0" alt="Addthis"/></a>-->
