...
if(isset($userid))
{
	...
	if($responsedata!=NULL)
	{
		...
		if(isset($_POST['load_value'])){
			...
			$_SESSION['pagedata_bookmark'] = $PageLimit;
		}
		
		if(!empty($_SESSION['pagedata_bookmark'])){
			$PageLimit =  $_SESSION['pagedata_bookmark'];
		}else{
			$PageLimit = "25";
  ...
  <div class="welcome"> 
    ...
    ?>
        ...
        <div class="row" id="load_more">
          ...
          <div class="col-sm-2" onClick="load_bookmark_page()">
