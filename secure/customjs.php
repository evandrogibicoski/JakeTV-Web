...
//            }
    ...
    function edit_register_join() {
        var f_name = document.getElementById('reg_f_name1').value;
        var l_name = document.getElementById('reg_l_name1').value;
        var email = document.getElementById('reg_email1').value;
        if (f_name == "") {
            document.getElementById('reg_validation1').innerHTML = "<div class='alert alert-danger' role='alert' style='font-size:16px;letter-spacing:1px;'>Enter First Name.</div>";
        }
        else if (l_name == "") {
            document.getElementById('reg_validation1').innerHTML = "<div class='alert alert-danger' role='alert' style='font-size:16px;letter-spacing:1px;'>Enter Last Name.</div>";
        }
        else if (email == "") {
            document.getElementById('reg_validation1').innerHTML = "<div class='alert alert-danger' role='alert' style='font-size:16px;letter-spacing:1px;'>Enter Email Id.</div>";
        }
        else {
            $.ajax({
                url: 'service.php',
                ...
                {
                    if (data == 1) {
                        document.getElementById('reg_validation1').innerHTML = "<div class='alert alert-success' role='alert' style='font-size:16px;letter-spacing:1px;'>You data successfuly updated. Go to login page.</div>";
                    } else {
                        document.getElementById('reg_validation1').innerHTML = "<div class='alert alert-danger' role='alert' style='font-size:16px;letter-spacing:1px;'>Your data not updated. Please try again.</div>";
                    }
                }
            });
        }
    ...
    function Cat_Post_List1(x) {
        ...
        $.ajax({
            ...
            success: function (data)
            {
                if (data == 2) {
                    var data1 = "<center class='notfound'><h2>Category not available.</h2></center>";
					$('#select_category_post1').html('');
                    $('#select_category_post1').append(data1);
                } else {
                    $('.content123_likes').hide();
                    $('#select_category_post1').html('');
                    $('#select_category_post1').append(data);
                }
            }
        });
    }
    function Cat_Post_List2(x) {
        var catid = x;
        ...
        $.ajax({
            ...
            success: function (data)
            {
                if (data == 2) {
                    var data1 = "<center class='notfound'><h2>Category not available.</h2></center>";
					$('#select_category_post2').html('');
                    $('#select_category_post2').append(data1);
                } else {
                    $('.content123_bookmark').hide();
                    $('#select_category_post2').html('');
                    $('#select_category_post2').append(data);
                }
            }
        });
    }
