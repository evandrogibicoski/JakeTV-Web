...
if($_SERVER['DOCUMENT_ROOT']=="/var/www/html")
{
	...
	$document	= $_SERVER['DOCUMENT_ROOT'].'/jaketv/jaketv_website/'; // Admin Panel
	$site_home	= $protocol."://".$_SERVER['HTTP_HOST']."/jaketv/jaketv_website/";
	$_SESSION["DOCUMENTPATH"]	= $document;
	$_SESSION["ADMINPATH"]		= $site_home;
...
else
{
	...
	$document	= $_SERVER['DOCUMENT_ROOT'].'/jaketv/jaketv_website/';
	$site_home	= $protocol."://".$_SERVER['HTTP_HOST']."/jaketv/jaketv_website/";
	$_SESSION["DOCUMENTPATH"]	= $document;
	$_SESSION["ADMINPATH"]		= $site_home;
	...
	$upload_img = "http://localhost/jaketv/jaketv_admin/uploads/postimage/";
...
function qry_fetchRows($qry)
{
   $result = @mysql_query($qry) or die(mysql_error().' at Line:'.__LINE__." ".$qry);
	...
	if ($num != 0) // if the result set contains atleast single row
	{
