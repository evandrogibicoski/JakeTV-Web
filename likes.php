                        ...
                        <div class="row" id="search_button">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group  label-floating" id="home_search_css">
                                    ...
                                    <input type="text" class="form-control input-lg" id="serachdata" onKeyUp="searcheddata(2)" style="border:none;border-bottom:1px solid #00AA9A;" />
                                </div>
                            </div>
                                        ...
                                        <ul class="dropdown-menu cat_drp_menu" role="menu">
                                            ...
                                            if (!empty($cat_list1)) {
                                                foreach ($cat_list1 as $cat_list1) {
                                                    ?>
                                                    <li><a  role="button" id="drop_li_part" onClick="Cat_Post_List1(<?php echo $cat_list1['catidu'] ?>)" style="cursor:pointer;"><?php echo $cat_list1['category']; ?></a></li>
                                                    <?php
                                                }
                                            } else {
                                                ?>
                            ...
                            if (isset($_SESSION['likes_pagedata'])) {
                                if ($_SESSION['likes_pagedata'] < $total_likes_rows) {
                                    ...
                                    <div class="row" id="load_more">
                                        ...
                                        <div class="col-sm-2" onClick="load_like_page1(<?php
                                        if (isset($_SESSION['likes_page'])) {
                                            echo ($_SESSION['likes_page']);
                                        } else {
                                            echo "undefined";
                                        }
                                        ?>,<?php echo $total_likes_rows; ?>)">
                                            <input type="hidden" id="load_value_hidden" name="load_value_hidden" value="<?php
                                            if (isset($_SESSION['likes_page'])) {
                                                echo ($_SESSION['likes_page'] + 1);
                                            } else {
                                                echo '1';
                                            }
                                            ?>"/>
