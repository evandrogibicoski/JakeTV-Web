    	...
    	<div class="col-sm-12 col-xs-12 col-md-12 col-lg-12" style="position:relative;">
            ...
            if(!empty($qry0['catid'])){
                ...
                foreach($fetchcat as $final){
                    ...
                    { ?>
                    <div class="col-lg-3">
                        <a class="btn btn-info btn-lg cat_id1<?php echo $final['catidu']; ?>" onclick="unset_user_cat_click(<?php echo $final['catidu']; ?>)" style="margin-bottom: 30px; background-color: #B1B1B1; width:100%; border-radius:0px; height:80px; padding-top:30px;"><?php echo $final['category']; ?></a>
                        <a class="btn btn-info btn-lg cat_id<?php echo $final['catidu']; ?>" onclick="user_cat_click(<?php echo $final['catidu']; ?>)" style="margin-bottom: 30px; display: none; border:1px solid gray; color:black; background-color:white; width:100%;border-radius:0px;height:80px;padding-top:30px;"><?php echo $final['category']; ?></a>
                    </div>
					<?php }else{ ?>
                    <div class="col-lg-3">
                        <a class="btn btn-info btn-lg cat_id<?php echo $final['catidu']; ?>" onclick="user_cat_click(<?php echo $final['catidu']; ?>)" style="margin-bottom: 30px; border:1px solid gray; color:black; background-color:white; width:100%;border-radius:0px;height:80px;padding-top:30px;"><?php echo $final['category']; ?></a>
                        <a class="btn btn-info btn-lg cat_id1<?php echo $final['catidu']; ?>" onclick="unset_user_cat_click(<?php echo $final['catidu']; ?>)" style="margin-bottom: 30px; display: none; background-color: #B1B1B1; width:100%;border-radius:0px;height:80px;padding-top:30px;"><?php echo $final['category']; ?></a>
        			</div>
                    <?php }
                }
